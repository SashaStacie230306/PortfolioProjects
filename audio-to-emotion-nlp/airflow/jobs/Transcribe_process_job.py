...
def main():
    ...
    # ✅ Hardcoded API Key
    api_key = "fd9b0f0712de418f921d3544afd50a94"
    ...
    # Define blob paths
    blob_input_path = (
        "UI/2025-06-23_144945_UTC/raw_data/Inside Polands Communist City  NOWA HUTA.mp3"
    )
    ...
    blob_client = blob_service_client.get_blob_client(
        container=container_name, blob=blob_input_path
    )
    ...
    output_client = blob_service_client.get_blob_client(
        container=container_name, blob=blob_output_path
    )
